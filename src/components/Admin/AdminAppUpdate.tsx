...
export const AdminAppUpdate: React.FC<AdminAppUpdateProps> = ({
  ...
  const handlePublishUpdateNow = (forceEnable: boolean = true) => {
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-[#16061e] border border-pink-500/30 rounded-3xl p-5 md:p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5 pt-4 border-t border-slate-800/80">
          <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-800">
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Current Build</p>
            <p className="text-sm font-black font-mono text-slate-200 mt-0.5">v{CURRENT_APP_VERSION}</p>
          </div>

          <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-800">
            <p className="text-[10px] text-pink-400 font-bold uppercase tracking-wider">Target Version</p>
            <p className="text-sm font-black font-mono text-pink-300 mt-0.5">v{settings.latestVersion}</p>
          </div>

          <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-800">
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">User Entry</p>
            <p className={`text-sm font-black mt-0.5 ${settings.enabled ? 'text-rose-400' : 'text-emerald-400'}`}>
              {settings.enabled ? '🚫 Blocked (Update Req.)' : '✅ Allowed'}
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-700 rounded-xl px-3 py-2.5 text-sm font-mono text-white placeholder-slate-500 focus:outline-none focus:border-pink-500"
                />
                <p className="text-[10px] text-slate-400 mt-1">Isse kam version wale users block ho jayenge.</p>
              </div>
            </div>
