          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                min={1}
                max={500}
                value={config.pricing?.referralRewardCoins ?? 10}
                onChange={(e) => handleRewardChange('referralRewardCoins', Number(e.target.value))}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                min={0}
                max={5000}
                value={config.pricing?.googleWelcomeBonusCoins ?? 10}
                onChange={(e) => handleRewardChange('googleWelcomeBonusCoins', Number(e.target.value))}
