...
export const LoginScreen: React.FC<LoginScreenProps> = ({
  ...
  return (
    <div className="w-full max-w-full min-h-[100dvh] bg-slate-950 text-slate-100 flex flex-col justify-between p-3.5 sm:p-5 select-none relative overflow-x-hidden overflow-y-auto touch-pan-y">
      ...
      {/* Top Header */}
      <div className="pt-2 sm:pt-4 flex flex-col items-center text-center relative z-10 shrink-0">
        <div className="mb-1.5 transform hover:scale-105 transition-transform duration-300">
          <RoxLogo size="md" showSparkle={true} />
        </div>
        <h1 className="text-xl sm:text-2xl font-black bg-gradient-to-r from-white via-slate-100 to-pink-300 bg-clip-text text-transparent tracking-tight leading-none">
          ROX FOLLOW
        </h1>
      ...
      <div className="w-full max-w-sm mx-auto my-auto py-3 relative z-10 shrink-0">
        <div className="bg-slate-900/90 backdrop-blur-xl border border-pink-500/25 rounded-2xl p-4 sm:p-5 shadow-2xl shadow-pink-500/10 text-center relative overflow-hidden">
          {/* Welcome Bonus Chip */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-pink-500/15 border border-pink-500/30 text-pink-300 text-[11px] font-bold mb-3 shadow-inner">
