  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center animate-pulse-glow">
        <div className="mb-6">
          <RoxLogo size="xl" showSparkle={false} />
        </div>

        <h1 className="text-2xl font-black bg-gradient-to-r from-white via-slate-100 to-amber-300 bg-clip-text text-transparent mb-2 tracking-tight">
          ROX FOLLOW
        </h1>
